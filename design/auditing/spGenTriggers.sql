CREATE OR ALTER PROCEDURE spGenAuditTriggers AS

DECLARE @schema NVARCHAR(20) = 'dbo' --mtc_admin
DECLARE @table NVARCHAR(255)
DECLARE @sql NVARCHAR(MAX)
  
DECLARE db_cursor CURSOR FOR
SELECT TABLE_SCHEMA, TABLE_NAME FROM INFORMATION_SCHEMA.TABLES
  WHERE TABLE_TYPE='BASE TABLE' AND TABLE_SCHEMA=@schema AND TABLE_NAME != 'audits'
