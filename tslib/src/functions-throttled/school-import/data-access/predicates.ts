...
export class SchoolImportPredicates {
  isSchoolOpen (logger: any, school: any) {
  ...
  isAgeInRange (logger: any, targetAge: number, school: any) {
  ...
  isRequiredEstablishmentTypeGroup (logger: any, school: any) {
