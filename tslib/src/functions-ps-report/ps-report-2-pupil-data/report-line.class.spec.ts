...
import { pupil as pupilCompletedCheck } from './mocks/pupil-who-completed-a-check.js'
import { pupil as pupilNotAttending } from './mocks/pupil-not-attending.js'
import { pupil as pupilAnnulledMaladmin } from './mocks/pupil-not-attending-annulled.js'
import { pupil as pupilAnnulledCheating } from './mocks/pupil-not-attending-annulled-cheating.js'
import { pupil as pupilIncomplete } from './mocks/pupil-with-incomplete-check.js'
import { pupil as pupilIncompleteCorrupt } from './mocks/pupil-not-attending-corrupt.js'
import { pupil as pupilCompleteRestartAvailableCorrupt } from './mocks/pupil-complete-and-restart-available-corrupt.js'
import { school } from './mocks/school.js'
import { answers } from './mocks/answers.js'
import { check } from './mocks/check.js'
import { check as checkIncomplete } from './mocks/check-incomplete.js'
import { checkConfig } from './mocks/check-config.js'
import { checkForm } from './mocks/check-form.js'
import { device } from './mocks/device.js'
import { events } from './mocks/events.js'
import { type NotTakingCheckCode, type RestartReasonCode } from './pupil-data.models.js'
import { type DfEAbsenceCode } from './transformer-models.js'
