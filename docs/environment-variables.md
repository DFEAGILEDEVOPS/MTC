...
--- | --- | --- | --- | --- | ---
 ...
 APPINSIGHTS_CONNECTION_STRING | String | '' | Optional, but should be set for Prod | AA, FT, FC, FP, PAPI | Connection string for v3 of Application Insights node package.
