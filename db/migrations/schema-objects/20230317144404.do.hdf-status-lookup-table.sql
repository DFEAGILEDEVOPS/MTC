CREATE TABLE [mtc_admin].[hdfStatusLookup](
	...
	[createdAt] [datetimeoffset](3) CONSTRAINT df_hdfStatusLookup_createdAt DEFAULT getutcdate() NOT NULL,
	[updatedAt] [datetimeoffset](3) CONSTRAINT df_hdfStatusLookup_updatedAt DEFAULT getutcdate() NOT NULL,
