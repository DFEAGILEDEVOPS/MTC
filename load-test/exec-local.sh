...
echo "#                                                                               #"
echo "#    * And the following is set....                                             #"
echo "#     - FUNCTION_CONSUMPTION_HOST_URL (if targeting a remote function host)     #"
echo "#                                                                               #"
echo "####################################################################¢############"
...
jmeter -n -t scenarios/_2020/live-long-teacher-journey-with-check-submit.jmx -JwaitTimeMs=0 -l reports/mtc_jmeter_test_result.csv -Djmeter.save.saveservice.output_format=csv -e -o html-report/
