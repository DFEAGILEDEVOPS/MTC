...
jmeter -n -t scenarios/2020/live-long-teacher-journey-with-check-submit.jmx -JwaitTimeMs=0 -l reports/mtc_jmeter_test_result.csv -Djmeter.save.saveservice.output_format=csv -e -o html-report/
