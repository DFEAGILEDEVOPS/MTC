...
module.exports.validate = (validationError, familiarisationCheckEndDateData) => {
  ...
  if (isFamiliarisationCheckEndDayEmpty || (!isFamiliarisationCheckEndDayEmpty && !isInt(familiarisationCheckEndDateData.familiarisationCheckEndDay, { min: 1, max: maxDaysInMonth }))) {
  ...
  if (isFamiliarisationCheckEndMonthEmpty || (!isFamiliarisationCheckEndMonthEmpty && !isInt(familiarisationCheckEndDateData.familiarisationCheckEndMonth, { min: 1, max: 12 }))) {
  ...
  if (isFamiliarisationCheckEndYearEmpty || (!isFamiliarisationCheckEndYearEmpty && !isInt(familiarisationCheckEndDateData.familiarisationCheckEndYear, { min: currentYear, max: (currentYear * 1 + 10) }))) {
