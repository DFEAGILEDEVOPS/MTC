...
module.exports.validate = (validationError, liveCheckStartDateData) => {
  ...
  if (isLiveCheckStartDayEmpty || (!isLiveCheckStartDayEmpty && !isInt(liveCheckStartDateData.liveCheckStartDay, { min: 1, max: maxDaysInMonth }))) {
  ...
  if (isLiveCheckStartMonthEmpty || (!isLiveCheckStartMonthEmpty && !isInt(liveCheckStartDateData.liveCheckStartMonth, { min: 1, max: 12 }))) {
  ...
  if (isLiveCheckStartYearEmpty || (!isLiveCheckStartYearEmpty && !isInt(liveCheckStartDateData.liveCheckStartYear, { min: currentYear, max: (currentYear * 1 + 10) }))) {
