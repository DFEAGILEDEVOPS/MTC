...
module.exports.validate = (validationError, adminStartDateData) => {
  ...
  if (isAdminStartDayEmpty || (!isAdminStartDayEmpty && !isInt(adminStartDateData.adminStartDay, { min: 1, max: maxDaysInMonth }))) {
  ...
  if (isAdminStartMonthEmpty || (!isAdminStartMonthEmpty && !isInt(adminStartDateData.adminStartMonth, { min: 1, max: 12 }))) {
  ...
  if (isAdminStartYearEmpty || (!isAdminStartYearEmpty && !isInt(adminStartDateData.adminStartYear, { min: currentYear, max: (currentYear * 1 + 10) }))) {
