...
module.exports.validate = (validationError, adminEndDateData) => {
  ...
  if (isAdminEndDayEmpty || (!isAdminEndDayEmpty && !isInt(adminEndDateData.adminEndDay, { min: 1, max: maxDaysInMonth }))) {
  ...
  if (isAdminEndMonthEmpty || (!isAdminEndMonthEmpty && !isInt(adminEndDateData.adminEndMonth, { min: 1, max: 12 }))) {
  ...
  if (isAdminEndYearEmpty || (!isAdminEndYearEmpty && !isInt(adminEndDateData.adminEndYear, { min: currentYear, max: (currentYear * 1 + 10) }))) {
