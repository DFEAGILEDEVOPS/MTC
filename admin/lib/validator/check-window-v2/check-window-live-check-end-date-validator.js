...
module.exports.validate = (validationError, liveCheckEndDateData) => {
  ...
  if (isLiveCheckEndDayEmpty || (!isLiveCheckEndDayEmpty && !isInt(liveCheckEndDateData.liveCheckEndDay, { min: 1, max: maxDaysInMonth }))) {
  ...
  if (isLiveCheckEndMonthEmpty || (!isLiveCheckEndMonthEmpty && !isInt(liveCheckEndDateData.liveCheckEndMonth, { min: 1, max: 12 }))) {
  ...
  if (isLiveCheckEndYearEmpty || (!isLiveCheckEndYearEmpty && !isInt(liveCheckEndDateData.liveCheckEndYear, { min: currentYear, max: (currentYear * 1 + 10) }))) {
