...
router.get('/service-message/submit-service-message', isAuthenticated(roles.serviceManager), (req, res, next) => serviceManagerController.getSubmitServiceMessage(req, res, next))
