...
router.get('/service-message/service-message-form', isAuthenticated(roles.serviceManager), (req, res, next) => serviceManagerController.getServiceMessageForm(req, res, next))
