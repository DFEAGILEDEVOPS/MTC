...
ALTER TABLE mtc_admin.pupilLogonEvent ALTER COLUMN pupilPin CHAR(5) NOT NULL;
ALTER TABLE mtc_admin.pupilLogonEvent ALTER COLUMN schoolPin CHAR(8) NOT NULL;
