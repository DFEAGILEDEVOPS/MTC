...
ALTER TABLE mtc_admin.pupilLogonEvent ALTER COLUMN pupilPin NVARCHAR(50) NOT NULL;
ALTER TABLE mtc_admin.pupilLogonEvent ALTER COLUMN schoolPin NVARCHAR(50) NOT NULL;
