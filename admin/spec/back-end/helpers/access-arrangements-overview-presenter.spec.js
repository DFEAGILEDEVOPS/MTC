...
describe('accessArrangementsOverviewPresenter', () => {
  describe('getPresentationData', () => {
    it('adds verticalBarStyle property if the pupil requires highlighting', () => {
    ...
    it('returns hasAAEditDisabled as true if user is not allowed to edit access arrangements for the particular pupil', () => {
    ...
    it('returns hasAAEditDisabled as true if the pupil has a completed check', () => {
    ...
    it('returns hasAAEditDisabled as true if the pupil cannot take the check', () => {
    ...
    it('returns hasAAEditDisabled as false if the user can edit access arrangements for a particular pupil, current check is incomplete and the pupil is taking the check', () => {
      const pupils = [{ urlSlug: 'urlSlug1', arrangements: [], hasCompletedCheck: false, notTakingCheck: false }]
      const hl = []
      const availabilityData = { canEditArrangements: true }
      const formattedPupils = accessArrangementsOverviewPresenter.getPresentationData(pupils, availabilityData, hl)
