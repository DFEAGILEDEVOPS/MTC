  ...
  describe('and the pupil uniqueness check passes', () => {
    ...
    describe('then date of birth:', () => {
      ...
      test('Can\'t be in the future', async () => {
        ...
        expect(validationError.get('dob-day')).toBe(pupilErrors.addPupil.dobInFuture)
        expect(validationError.get('dob-month')).toBe(pupilErrors.addPupil.dobInFuture)
        expect(validationError.get('dob-year')).toBe(pupilErrors.addPupil.dobInFuture)
      })
