...
describe('date service', () => {
  ...
  describe('createUTCDateFromDayMonthYearTime', () => {
    it('creates an ISO date based on given day month and year with default time set', () => {
      const isoDate = dateService.createUTCDateFromDayMonthYearTime('1', '5', '2010')
    ...
    it('creates an ISO date based on given day month and year and time', () => {
      const isoDate = dateService.createUTCDateFromDayMonthYearTime('1', '5', '2010', '23:59:59')
