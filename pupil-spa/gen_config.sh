...
testPupilConnectionDelay=${TEST_PUPIL_CONNECTION_ERROR_DELAY:-"testPupilConnectionDelayValue"}
testPupilConnectionMaxAttempts=${TEST_PUPIL_CONNECTION_MAX_ATTEMPTS:-"testPupilConnectionMaxAttemptsValue"}
connectivityCheckEnabled=${CONNECTIVITY_CHECK_ENABLED:-"connectivityCheckEnabledValue"}
