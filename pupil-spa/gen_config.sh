...
testPupilConnectionQueueName=${TEST_PUPIL_CONNECTION_QUEUE_NAME:-""}
testPupilConnectionQueueUrl=${TEST_PUPIL_CONNECTION_QUEUE_URL:-""}
testPupilConnectionQueueToken=${TEST_PUPIL_CONNECTION_QUEUE_TOKEN:-""}
