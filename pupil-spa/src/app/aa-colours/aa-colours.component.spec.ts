...
describe('AAColoursComponent', () => {
  ...
  it('should redirect to the access-settings page on click if the user has navigated from access-settings', fakeAsync(() => {
  ...
  it('should redirect to the sign-in-success page on click if the user has not navigated from access-settings', fakeAsync(() => {
  ...
  it('should redirect to the sign-in-success page on click if previous url is undefined', fakeAsync(() => {
