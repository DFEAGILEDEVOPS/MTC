...
app.on('ready', () => {
  ...
  const errorUrl = 'file:///' + __dirname + '/../app/error.html';
  const installationUrl = 'file:///' + __dirname + '/../app/installation.html';
  const trialOverUrl = 'file:///' + __dirname + '/../app/trial-over.html';
