class SignInFailurePage < SitePrism::Page
  ...
  element :error_message, ".lede", text: "The details entered do not match our records. Please check with your teacher that you used the correct pupil PIN and have entered your details accurately."
