class AccessArrangementsPage < SitePrism::Page
  ...
  element :information, '.lede', text: "Modify the check for pupils with specific needs. The arrangements that are applied can be previewed and configured by the pupils in the 'Try it out' area."
