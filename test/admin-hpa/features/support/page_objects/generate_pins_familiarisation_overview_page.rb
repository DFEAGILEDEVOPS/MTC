class GeneratePinsFamiliarisationOverviewPage < SitePrism::Page
  ...
  element :generate_pin_message, '.lede', text: "Pupils will need a personal identification number (PIN) and school password to start the ‘Try it out’ area. The link for pupils to try it out is: #{ENV['PUPIL_BASE_URL']} These expire at 4pm daily."
