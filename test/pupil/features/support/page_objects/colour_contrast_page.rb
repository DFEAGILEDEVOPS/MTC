class ColourContrastPage < SitePrism::Page
  ...
  section :black_on_white_preview, '.preview-box.contrast-bow' do
    element :badge, '.badge', text: 'Colour preview'
    element :question, '.question-text'
    elements :number_pad, 'td button'
  end

  section :yellow_on_black_preview, '.preview-box.contrast-yob' do
    element :badge, '.badge', text: 'Colour preview'
    element :question, '.question-text'
    elements :number_pad, 'td button'
  end

  section :black_on_blue_preview, '.preview-box.contrast-bob' do
    element :badge, '.badge', text: 'Colour preview'
    element :question, '.question-text'
    elements :number_pad, 'td button'
  end

  section :black_on_peach_preview, '.preview-box.contrast-bop' do
    element :badge, '.badge', text: 'Colour preview'
    element :question, '.question-text'
    elements :number_pad, 'td button'
  end

  section :black_on_cream_preview, '.preview-box.contrast-boc' do
    element :badge, '.badge', text: 'Colour preview'
    element :question, '.question-text'
    elements :number_pad, 'td button'
  end
