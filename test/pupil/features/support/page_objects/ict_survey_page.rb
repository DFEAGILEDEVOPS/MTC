class IctSurveyPage < SitePrism::Page
  ...
  element :purpose_message, '.heading-medium', text: "The purpose of this survey is to help us understand the information and communications technology (ICT) used in schools."
  ...
  section :more_detail, 'details' do
    ...
    element :ict_test_list, '.panel-border-narrow ul li', text: 'browser settings'
    element :ict_test_list, '.panel-border-narrow ul li', text: 'connection speed'
    element :ict_test_list, '.panel-border-narrow ul li', text: 'device type (if available)'
    element :ict_test_list, '.panel-border-narrow ul li', text: 'operating system'
    element :ict_test_list, '.panel-border-narrow ul li', text: 'processing speed'
    element :ict_test_list, '.panel-border-narrow ul li', text: 'screen width'
    element :ict_test_info, '.panel-border-narrow p', text: "During this process, data files will be downloaded, held temporarily and then deleted. All data will be anonymised unless contact details are provided in your feedback"
  end
