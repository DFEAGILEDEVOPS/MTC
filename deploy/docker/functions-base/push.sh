...
docker tag $IMAGE_ID stamtc/mtc-azure-functions-base:latest
TODAY_ISO=$(date -u +"%Y%m%dT%H%M")
docker tag $IMAGE_ID stamtc/mtc-azure-functions-base:$TODAY_ISO
docker push stamtc/mtc-azure-functions-base
